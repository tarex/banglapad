( function ( $ ) {
	...
	IMESelector.prototype = {
		...
		prepareSelectorMenu: function () {
			...
			this.$menu = $( '<div class="imeselector-menu" role="menu" style="display:none !important;">' );
		...
		position: function () {
			...
			this.$element.parents().each( function() {
				if ( $( this ).css( 'position' ) === 'fixed' ) {
					imeSelector.$imeSetting.css( {'position':'fixed','display':'none'} );
					return false;
				}
			} );
